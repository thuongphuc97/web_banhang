...
<div class="row">
    <div class="col-3 card">
        ...
        <ul class="list-group" style="padding-top: 40px;">
            ...
            <li class="list-group-item">
                <a href="/LAB03/list_product.php?cat_id=<?php echo $item["CateID"];?>"><?php echo $item["CategoryName"];?></a>
            </li>
            <?php endforeach;?>
        </ul>
    </div>
    ...
    <div class="col-9 card">
        ...
        <div class="row">
            <div class="col-6">
                <img src="/LAB03/<?php echo $prods["Picture"] ?>" class="product-detail-img" alt="">
            </div>
            <div class="col-6">
        ...
        <div class="row">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="/LAB03/product-detail.php?id=<?php echo $item["ProductID"] ?>"><?php echo $item["ProductName"] ?></a></h5>
